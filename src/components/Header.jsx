...
function Header() {
  ...
  return (
    <header className="lg:fixed flex lg:flex-col justify-between lg:justify-between items-center bg-[#373B53] dark:bg-[#1E2139] lg:rounded-r-[20px] lg:h-screen">
      ...
      <div className="flex lg:flex-col items-center gap-4 md:gap-6 w-full max-w-[130px]">
        <img
          ...
          alt="Theme Toggle"
        />
        <button className="border-[#494E6E] px-4 py-3 lg:border-t-[1.5px] border-l-[1.5px] lg:border-l-0 w-full text-center">
